...
export const CircleStarIcon: React.FC = () => {
  return (
    <svg viewBox="0 0 26 26">
      <path
        fill="currentColor"
        d="M13.002 0C5.828 0 0 5.826 0 13s5.828 13 13.002 13S26 20.174 26 13 20.176 0 13.002 0zm0 1C19.635 1 25 6.367 25 13a11.99 11.99 0 0 1-11.998 11.998C6.369 24.998 1 19.633 1 13 1 6.367 6.369 1 13.002 1zm.039 5c-.055.071-.107.131-.178.244-.213.342-.464.836-.713 1.346-.248.51-.496 1.039-.72 1.474-.113.218-.22.411-.325.577-.104.165-.178.3-.369.435-.19.136-.342.163-.533.207-.19.045-.41.082-.652.117-.486.071-1.067.135-1.631.204-.565.069-1.115.146-1.508.236-.13.03-.203.059-.289.088.05.074.092.142.178.244.26.307.653.698 1.062 1.092.41.393.838.79 1.184 1.138.173.174.326.335.451.485.125.15.228.264.299.486.07.222.051.374.035.568a7.77 7.77 0 0 1-.09.657c-.083.482-.204 1.052-.312 1.609a16.159 16.159 0 0 0-.24 1.502c-.012.133-.008.212-.006.303.087-.026.165-.045.289-.096a16.23 16.23 0 0 0 1.369-.67c.502-.267 1.012-.549 1.451-.77.22-.11.42-.204.602-.277.181-.072.322-.135.556-.135.234.002.372.068.553.143.18.075.38.175.598.29.434.227.94.517 1.437.792.498.275.988.534 1.36.691.122.052.2.074.287.1.002-.09.007-.17-.002-.303a16.12 16.12 0 0 0-.215-1.506c-.1-.558-.21-1.13-.285-1.615a7.766 7.766 0 0 1-.08-.656c-.013-.195-.03-.347.044-.568.074-.222.18-.333.307-.48a7.79 7.79 0 0 1 .46-.48c.35-.341.784-.732 1.2-1.118.416-.387.815-.771 1.08-1.075.088-.1.13-.168.182-.242-.085-.03-.157-.06-.287-.092-.392-.096-.94-.18-1.504-.26-.563-.078-1.144-.15-1.629-.228-.242-.04-.46-.08-.65-.127-.19-.048-.34-.08-.528-.219-.188-.138-.261-.272-.363-.44a7.717 7.717 0 0 1-.314-.581c-.218-.44-.457-.97-.698-1.485-.24-.514-.484-1.012-.691-1.357-.069-.114-.118-.176-.172-.248z"
      ></path>
    </svg>
  );
};
...
export const VerticalArrowIcon: React.FC = () => {
  return (
    <svg viewBox="0 0 24 24">
      <path
        fill="currentColor"
